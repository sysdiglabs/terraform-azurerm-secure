...
| <a name="input_enable_platform_logs"></a> [enable\_platform_logs](#input\_enable\_platform_logs) | (Optional) Used to enable Platform logs, defaults to true. | `bool` | `true` | no |
| <a name="input_enable_entra"></a> [enable\_entra](#input\_enable\_entra) | (Optional) Used to enable Entra logs, defaults to true. | `bool` | `true` | no |
